# -*- coding: utf-8 -*-
#
# pypi-download-stats documentation build configuration file, created by
...
if is_rtd:
    ...
    htmlhelp_basename = 'pypi-download-statsdoc'
...
latex_documents = [
  (master_doc, 'pypi-download-stats.tex', u'pypi-download-stats Documentation',
...
man_pages = [
    (master_doc, 'pypi-download-stats', u'pypi-download-stats Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pypi-download-stats', u'pypi-download-stats Documentation',
   author, 'pypi-download-stats', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://testpypi\.python\.org/pypi/pypi-download-stats'
]
